...
def extract_content_for_date_range(start_date, end_date):
    ...
    while current_date <= end_date:
        ...
        url = f"https://www.opinion.com.bo/archive/content/{current_date.year}/{current_date.month:02d}/{current_date.day:02d}/"
...
if __name__ == "__main__":
    ...
    with open('page_content5.txt', 'w', encoding='utf-8') as file:
